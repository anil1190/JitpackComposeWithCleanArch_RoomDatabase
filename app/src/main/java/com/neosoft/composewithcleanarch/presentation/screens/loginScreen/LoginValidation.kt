...
import com.neosoft.composewithcleanarch.presentation.screens.loginScreen.LoginViewModel
import com.neosoft.composewithcleanarch.presentation.utils.*


@OptIn(ExperimentalComposeUiApi::class, ExperimentalLifecycleComposeApi::class)
@Composable
fun LoginValidationScreen(viewModel: LoginViewModel = hiltViewModel()) {
    ...
    Column(
        ...
        Button(onClick = viewModel::onRegistrationClick, enabled = true) {
            Text(text = "SignUp")
        }
    }
